...
// import { ArrowRight, Sparkles, Code, Server, Database, Cpu } from 'lucide-react'
...
//                   whileHover={{ scale: 1.05 }}
//                   className="flex items-center space-x-2 px-4 py-2 rounded-lg bg-secondary/50 backdrop-blur-sm"
//                 >
...
//               className="absolute -top-8 left-8 p-4 rounded-2xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 backdrop-blur-sm border border-white/10"
//             >
...
//               className="absolute top-1/2 -right-8 p-4 rounded-2xl bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 backdrop-blur-sm border border-white/10"
//             >
...
//               className="absolute bottom-8 left-1/4 p-4 rounded-2xl bg-gradient-to-br from-amber-500/10 to-orange-500/10 backdrop-blur-sm border border-white/10"
//             >
...
//               <div className="gradient-border rounded-3xl p-8 backdrop-blur-sm bg-white/5 dark:bg-black/5">
...
//                     <div className="text-lg font-bold">Building Digital</div>
//                     <div className="text-lg font-bold text-gradient">Experiences</div> */}
//                     <img src="/ravindra.png" alt="Hero"  className="rounded max-h-96 max-w-96" />
//                   </div>
//                 </div>
//               </div>  
      ...
      <div className="container relative z-10 mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            {/* Profile Image Container */}
            <div className="relative mx-auto max-w-[400px]"> {/* Added max-width to keep it proportional */}
              {/* Outer Glow */}
              ...
              <div className="relative rounded-2xl overflow-hidden gradient-border p-2 bg-background/50">
                {/* Changed h-[500px] to aspect-[4/5] to match your image ratio.
       Added w-full to ensure it fills the max-width.
    */}
