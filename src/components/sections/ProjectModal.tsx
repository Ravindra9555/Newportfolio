...
//               className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-2xl gradient-border bg-background"
//             >
//               {/* Close Button */}
//               <button
//                 onClick={onClose}
//                 className="absolute right-6 top-6 z-10 p-2 rounded-full bg-secondary hover:bg-accent transition-colors"
//                 aria-label="Close"
//               >
//                 <X className="h-5 w-5" />
//               </button>
...
//                           target="_blank"
//                           rel="noopener noreferrer"
//                           className="p-3 rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 text-white"
...
//                       <div className="font-bold capitalize">{project.category}</div>
//                     </div>
